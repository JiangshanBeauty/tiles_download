...
def download_tile(tileurl, savepath, retries=download_retries):
    ...
    try:
        response = requests.get(tileurl, headers=headers, timeout=15)
...
def main():
    # 设置瓦片范围和下载路径
    minlon, minlat = 117.19322204, 23.451908  # 左下角坐标
    maxlon, maxlat = 117.7878570556, 23.84816199  # 右上角坐标
    minzoom, maxzoom = 16, 18
    basetileurl = 'http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}'
    rootpath = '/data/tile/arcgis_ds'
